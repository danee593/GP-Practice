...
def main():
    ...
    merged_gp_patient_survey_renamed.to_csv("raw_data/Practice Survey/Data Merged/gp_patient_survey.csv")
...
def import_data_frames() -> dict:
    ...
    '''
    files_path:str = "raw_data/Practice Survey/GPPS_{}_Practice_data_(weighted)_(csv)_PUBLIC.csv"
...
def import_metadata() -> dict:
    ...
    metadata = {"year": "year"}
    try:
        with open("raw_data/Practice Survey/Metadata.csv", "r") as file:
